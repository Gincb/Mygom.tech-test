...
describe("Filter Tabs functionality", () => {
  ...
  it("should return true if there are older items than 30 days", () => {
    expect(itemIsOld(items).length).toBe(1)
  })

  it("should return true if there are reused items", () => {
    expect(itemIsReused(items[0], items)).toBe(true)
  })

  it("should return true if there are invalid items", () => {
